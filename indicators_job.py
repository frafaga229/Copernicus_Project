...
def get_indicator_plots(args_):
    ...
    new_words =  ['the', 'a ','us', 'sold', 'of', 'in', 'created', 'that', 'made', 'we\'ve', 'after', 'struggling','their','his','only','previously','leaving', 'et','c3s', 'otg',
                 ...
                 'process', 'download', 'analyse', 'snap', 'visualize', 'employ', 'products', 'provides', 'efas', 'processing', 'plus', 'clients', 'bac', 'minimum', 'dune',
                  'lensemble', 'ans', 'pme', 'recrute', 'client', '2', 'fonctions', 'france', 'groupe', 'issues', 'dun', 'hf', 'fh']
