FORMAT_COL = {
    ...
    **dict.fromkeys(['Organisation', 'organisation', 'Organization', 'organization', 'ORG1', 'Organisme', ], 'Organisation'),
    **dict.fromkeys(['Org. Country', 'org. country', 'Place', 'place','Region', 'region', 'Country', 'country', 'Région / à distance'], 'Org. Country'),
    **dict.fromkeys(['Language', 'language'], 'Language'),
    **dict.fromkeys(['Diploma', 'diploma', 'Level', 'level'], 'Diploma'),
    **dict.fromkeys(['Duration', 'duration'], 'Duration'),
...
DICT_LEVEL = {
    ...
    **dict.fromkeys(['Licence', 'Bachelor', 'Bachelor\x92s', "Bachelor's",  ], 'License'),
